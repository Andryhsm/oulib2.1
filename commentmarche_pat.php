                    ...
                    <div class="section-content">
                        <div class="container">
                            <div class="alchem-animated animated fadeInRight" data-animationduration="0.9" data-animationtype="fadeInRight" data-imageanimation="no" style="visibility: visible; animation-duration: 0.9s;">
                                ...
                                <div class="section-subtitle alchem_section_4_sub_title"><center><h4><b>Trouvez facilement votre infirmière avec oulib</b></h4></center></div>
                            ...
                            <div class="row">
                                <div class=" col-md-2_5">
                                    ...
                                    <div class="alchem-animated alchem_section_4_image animated fadeInDown" data-animationduration="1.2" data-animationtype="fadeInDown" data-imageanimation="no" style="visibility: visible; animation-duration: 1.2s;">
                                        <img src="./img/ccm2.jpg" alt="" style="visibility: visible;"><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3_5">
                                    <div class="alchem-animated alchem_section_4_feature_image_2 animated fadeInRight" data-animationduration="1.2" data-animationtype="fadeInRight" data-imageanimation="no" style="visibility: visible; animation-duration: 1.2s;">
                                        <div class="magee-feature-box style2" data-os-animation="fadeOut" style="padding-left: 65px;">
                                            <h4>Inscription :</h4>
                                                <li>Renseignez votre disponibilité, type de soins que vous avez besoin ainsi que votre adresse</li>
                                                <li>Vous allez apparaitre automatiquement sur une carte, les infirmières autour de vous peuvent voir votre demande et prendre un RDV en ligne avec vous.</li>
                                                <li>Vous recevez en temps réel les informations sur l’acceptation ou le refus de votre demande.</li>
                                            <h4>Les avantages :</h4>
                                                <li>Données et systèmes d’information de santé (SIS) sécurisées</li>
                                                <li>Trouvez facilement l’infirmière dédiée et spécialisée à votre besoin</li>
                                            <h4>Oulib vous facilite la vie :</h4>
                                                <li>Commander votre prescription en quelques clics</li>
                                                <li>Nous livrons gratuitement à votre domicile les matériels de soins nécessaires.</li>
