                        ...
                        <div class="alchem-animated animated fadeInRight" data-animationduration="0.9" data-animationtype="fadeInRight" data-imageanimation="no" style="visibility: visible; animation-duration: 0.9s;">
                            <div class="magee-promo-box">
                                ...
                                <?php for ($i=1, $i<= 7, $i++){
                                                $j = $i + 1;
                                            echo '
                                            <div class="form-group" id="type'.$i.'" style="display: none;">
                                                <label for="type-soin'.$j.'" class="col-sm-2 control-label">Autre type de soin:</label>
                                                <div class="col-sm-9">
                                                    <select name="type-soin'.$j.'" onchange="type'.$j.'()" class="form-control" id="select'.$j.'">
                                                        ...
                                                        <option id="diabetique'.$i.'" value="Prise en charge des patients diabétiques">Prise en charge des patients diabétiques </option>
                                           ...
                                           <script>
                                                ...
                                                function type'.$j.'() {
                                                    var selection = document.getElementById("select'.$j.'").value;
                                                    if (selection === "Soins de stomie")
                                                    {
                                                        var i = '.$j.';
                                                        while (i <= 7){
                                                            i++;
                                                            var element = document.getElementById("stomie"+i);
                                                            element.parentNode.removeChild(element);
                                                        }
                                                    } else if (selection === "Soins des plaies")
                                                    {
                                                      var i = '.$j.';
                                                        while (i <= 7){
                                                            i++;
                                                            var element = document.getElementById("plaies"+i);
                                                            element.parentNode.removeChild(element);
                                                        }
                                                    } else if (selection === "Soins d’oncologie et traitement de chimiothérapie")
                                                    {
                                                        ...
                                                        while (k< 8){
                                                            k++;
                                                            var element = document.getElementById("oncologie"+k);
                                                            element.parentNode.removeChild(element);
                                                        }
                                                    } else if (selection === "Perfusion")
                                                    {
                                                        ...
                                                        while (l< 8){
                                                            l++;
                                                            var element = document.getElementById("perfusion"+l);
                                                            element.parentNode.removeChild(element);
                                                        }
                                                    }
                                                    else if (selection === "Prise de sang")
                                                    {
                                                        ...
                                                        while (m< 8){
                                                            m++;
                                                            var element = document.getElementById("sang"+m);
                                                            element.parentNode.removeChild(element);
                                                        }
                                                    }
                                                    else if (selection === "Injection sous cutané, intramusculaire, intraveineuse")
                                                    {
                                                        ...
                                                        while (n< 8){
                                                            n++;
                                                            var element = document.getElementById("injection"+n);
                                                            element.parentNode.removeChild(element);
                                                        }
                                                    }
                                                    else if (selection === "Prise en charge des patients diabétiques")
                                                    {
                                                        ...
                                                        while (o< 8){
                                                            o++;
                                                            var element = document.getElementById("diabetique"+o);
                                                            element.parentNode.removeChild(element);
                                                        }
                                                    }
                                                    else if (selection === "Aide à la toilette")
                                                    {
                                                        ...
                                                        while (p < 8){
                                                            p++;
                                                            var element = document.getElementById("toilette"+p);
                                                            element.parentNode.removeChild(element);
                                                        }
                                                    }
                                                    else if (selection === "Préparation et distribution des traitements")
                                                    {
                                                        ...
                                                        while (q< 8){
                                                            q++;
                                                            var element = document.getElementById("prepa"+q);
                                                            element.parentNode.removeChild(element);
                                                        }
                                                    } 

                                                    document.querySelector("#type'.$j.'").style.display = (window.getComputedStyle(document.querySelector(\'#type'.$j.'\')).display == \'none\') ? "block" : "hide";
                                                }
                                                ';
                                    }
                                                ?>
